...
export class NCICloseButton {
	...
	public unregister(): void {
		...
		// Unset cookie
		document.cookie = `NCISiteAlert=; Path=${this.options.cookie.path}; Expires=Thu, 01 Jan 1970 00:00:01 GMT`;
	...
	private handleClose(): void {
		document.cookie = `NCISiteAlert=${this.element.id}; Path=${this.options.cookie.path}`;
		this.hideSiteAlert();
