...
export const BlogSeriesCategory = {
	args: {
		series: {
			title: 'Cancer Risk - Cancer Currents Blog',
			field_intro_text:
			...
			categories: [
				{ name: 'Biology of Cancer', isSelected: false },
				{ name: 'Cancer Risk', isSelected: true },
				{ name: 'Childhood Cancer', isSelected: false },
				{ name: 'Clinical Trail Results', isSelected: false },
				{ name: 'Disparities', isSelected: false },
				{ name: 'FDA Approval', isSelected: false },
...
export const BlogSeriesArchive = {
	args: {
		series: {
			title: '2025 - Cancer Currents Blog',
			body: bodyContent,
			categories: [
				{ name: 'Biology of Cancer', isSelected: false },
				{ name: 'Cancer Risk', isSelected: false },
