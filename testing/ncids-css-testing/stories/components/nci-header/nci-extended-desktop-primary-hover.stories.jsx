    ...
    <div class="nci-header--nci-nav__inner">
		<ul class="nci-header--nci-nav__primary">
			<li class="nci-header--nci-nav__primary-item">
				<a href="/"  class="nci-primary__button hover" aria-expanded="false" aria-controls="extended-mega-nav-section-one">
					<span>Current section</span>
				</a>
			</li>
			<li class="nci-header--nci-nav__primary-item">
				<a href="/"  class="nci-primary__button hover" aria-expanded="false" aria-controls="extended-mega-nav-section-two">
