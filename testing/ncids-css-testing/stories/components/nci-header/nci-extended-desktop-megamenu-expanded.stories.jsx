...
import logo from './img/nci-logo-full.svg';

// the default usa menu button has been moved into the .usa-nav__inner
//  to work with our search and mobile menu. 
    ...
    <div class="nci-header--nci-nav__inner">
		<ul class="nci-header--nci-nav__primary">
			<li class="nci-header--nci-nav__primary-item">
					<a href="/"  class="nci-primary__button usa-current" aria-expanded="true" aria-controls="extended-mega-nav-section-one">
          ...
          <div id="extended-mega-nav-section-one" class="usa-nav__submenu usa-megamenu">
					...
					<div class="grid-row">
						...
						<div class="usa-col grid-gap-3">
							<div class="nci-header--submenu-header"><a href="/about-cancer">Explore Section</a></div>
						</div>
