...
const html = `
	<section
		aria-label="Standard emergency site alert expanded with close button example"
	...
	>
		<div class="usa-alert">
			<div class="usa-alert__body">
				...
				<div class="usa-alert__nci-content" aria-hidden="false">
...
export const NCIStandardEmergencyExpandedWithClose = () => (
