...
const html = `
	<section
		aria-label="Standard emergency site alert collapsed with close example"
		...
		<div class="usa-alert">
			<div class="usa-alert__body">
				<div class="usa-alert__nci-header">
					...
					<div class="usa-alert__nci-content hidden" id="site-alert-collapse" aria-hidden="true">
			...
			<button
				...
				aria-label="Dismiss standard emergency alert"
			>
...
export const NCIStandardEmergencyWithClose = () => (
