...
Typography helps establish hierarchy by presenting clear visual patterns for different functions. The NCI Design System supports 3 Google fonts, which are easy for designers to embed into Figma and developers to utilize in code.
