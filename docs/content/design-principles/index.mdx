...
## Visual Style <Icon description="picture icon" glyph="image" style="vertical-align: middle" />

Promotes consistency and one visual voice so users can find cancer related content efficiently.

## Accessibility <Icon description="accessibility icon" glyph="accessibility_new" style="vertical-align: middle" />

Uses inclusive and representative visuals that engage all users.

## User Research <Icon description="chat icon" glyph="chat" style="vertical-align: middle" />

Builds empathy with users by testing often and gathering feedback.

## Reusable Code <Icon description="code icon" glyph="code" style="vertical-align: middle" />

Simplifies development. Code is friendly, easy to use and accessible.

## Governance <Icon description="people icon" glyph="people" style="vertical-align: middle" />
