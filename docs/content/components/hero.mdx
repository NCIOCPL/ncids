...
code_snippets:
  elements:
    - title: Default Hero
      preview: true
      twig_template_path: components/nci-hero/nci-hero.twig
      code: >
        {
          "image": {
            "widescreen": "../nci-hero-images/hero-widescreen.jpg",
            "desktop": "../nci-hero-images/hero-desktop.jpg",
            "tablet_lg": "../nci-hero-images/hero-tablet-large.jpg",
            "tablet": "../nci-hero-images/hero-tablet.jpg",
            "mobile_lg": "../nci-hero-images/hero-mobile-large.jpg",
            "mobile": "../nci-hero-images/hero-mobile.jpg"
          },
    ...
    - title: Hero with Button with External Link Icon
      description: |
      twig_template_path: components/nci-hero/nci-hero.twig
      code: >
        {
    ...
    - title: Hero with Button Internal Link with External Link Icon Override
      description: |
      twig_template_path: components/nci-hero/nci-hero.twig
      code: >
        {
    ...
    - title: External Link with Internal Link Override
      description: |
      twig_template_path: components/nci-hero/nci-hero.twig
      code: >
        {
