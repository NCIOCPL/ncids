...
figma_link: https://www.figma.com/file/4FeMfprVErO6esR8FLczp5/NCIDS-Design-Kit?type=design&node-id=5280%3A39866&mode=design&t=lGwrxbWFW3JAwAet-1

overview:
  whitebg: true
  imgsrc: breadcrumb.png
  imgalt: Example of three text links separated by chevrons, ending with non-linked text.
  elements:
