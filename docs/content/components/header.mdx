...
description: |
  The header is the top portion of a webpage — it includes a logo, search, and primary site navigation. A header allows users to the website's organizational structure and provides a quick, organized way to reach the main sections of a website. The header should be consistent across all the pages of a website.
...
accessibility: |
  ...
  ### Arial-Label Mobile Menu Translations Table
...
code_snippets:
  elements:
    - title: NCI extended header with mega menu
      preview: true
      code: |
        <header
