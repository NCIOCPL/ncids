...
best_practices: |
  ...
  **For Mobile Large and Mobile breakpoints, no image will be displayed**
  ...
  - To override an EXTERNAL link to be displayed as INTERNAL, add the class `nci-card--internal`
  - To override an INTERNAL link to be displayed as EXTERNAL, add the class `nci-card--external`
  - (Examples provided below in [Code Snippets](#code-snippets))
...
code_snippets:
  elements:
    ...
    - title: Card with Internal Link Overridden to Display as External
      preview: true
      twig_template_path: components/nci-card/nci-card.twig
      code: >
        {
    ...
    - title: Card with External Link Overridden to Display as Internal
      preview: true
      twig_template_path: components/nci-card/nci-card.twig
      code: >
        {
