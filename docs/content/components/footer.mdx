...
overview:
  ...
  elements:
    ...
    - description: Link
    - description: Subscription Call-to-Action
    - description: NCI DOC Name
...
code_snippets:
  elements:
    ...
    - title: Back to Top without JavaScript
      description: |
        For sites without JavaScript, you will need to add your own 'back to top' feature to comply with accessibility regulations.

        First create a simple anchor tag at the top of your page. This should be placed at the beginning of where the readable content begins.

        `<a name="top"></a>`

        Next you will need to place an anchor link at the end of your content which references the anchor link above by making the href match the name.
