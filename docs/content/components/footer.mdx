...
<div className="usa-alert usa-alert--info usa-alert--slim">
	<div className="usa-alert__body">
		<p className="usa-alert__text">
			<pre className="display-inline">usa-big</pre> has been modified to make
			accordion mobile-first. See{' '}
			<pre className="display-inline">
				.usa-footer__primary-content--collapsible.hidden .usa-list--unstyled
			</pre>
		</p>
	</div>
</div>
