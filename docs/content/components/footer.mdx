                  ...
                  <div class="usa-sign-up">
                    ...
                    <form
                      ...
                      <button
                        ...
                        type="button"><!-- IMPORTANT: Button type should be changed to "submit" -->
                        Sign up
                      </button>
                    </form>
                  </div>
...
updates:
  - date: 2023-01-24
    ...
    affects: >-
      Footer
    description: >-
      Twitter logo updated to X
  - date: 2023-03-10
    version: v1.3.0
    affects: >-
      Footer
    description: >-
      Replace h3 elements to div elements
  - date: 2023-03-07
    version: v1.2.0
    affects: >-
      Footer Storybook
...
<NciDsJsInit path={props.pageContext.pagePath}>{`
	...
	window.ncids.NCIBigFooter.create(footer);
`}</NciDsJsInit>
