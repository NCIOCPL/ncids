...
- `collapseButtonClass` - Button that toggles collapsible section. String. Default `.usa-footer__nci-primary-link--accordion-header`
- `collapseWidth`- Screen width required to convert the footer navigation into an accordion. Number. Default `480`
            ...
            <div class='grid-row grid-gap-4'>
              <div class='mobile-lg:grid-col-6 desktop:grid-col-4'>
                <section class='usa-footer__primary-content usa-footer__primary-content--collapsible'>
                  <h4>
                    <span class='usa-footer__primary-link usa-footer__nci-primary-link--list-header'>Primary link 1</span>
                  </h4>
                  <ul class='usa-list usa-list--unstyled'>
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 1</a>
                    </li>
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 2</a>
                    </li>
                    <li class='usa-footer__secondary-link'>
                    ...
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 4</a>
                    </li>
                  </ul>
                </section>
              </div>
              <div class='mobile-lg:grid-col-6 desktop:grid-col-4'>
                <section class='usa-footer__primary-content usa-footer__primary-content--collapsible'>
                  <h4>
                    <span class='usa-footer__primary-link usa-footer__nci-primary-link--list-header'>Primary link 2</span>
                  </h4>
                  <ul class='usa-list usa-list--unstyled'>
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 5</a>
                    </li>
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>
                    ...
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 7</a>
                    </li>
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 8</a>
                    </li>
                  </ul>
                </section>
              </div>
              <div class='mobile-lg:grid-col-6 desktop:grid-col-4'>
                <section class='usa-footer__primary-content usa-footer__primary-content--collapsible'>
                  <h4>
                    <span class='usa-footer__primary-link usa-footer__nci-primary-link--list-header'>Primary link 3</span>
                  </h4>
                  <ul class='usa-list usa-list--unstyled'>
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 9</a>
                    </li>
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 10</a>
                    </li>
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 11</a>
                    </li>
                    <li class='usa-footer__secondary-link'>
                      <a href='javascript:void(0);'>Secondary link 12</a>
                    </li>
                  </ul>
                </section>
              </div>
          ...
          <div class='usa-footer__address'>
            <div class='usa-footer__contact-info grid-row grid-gap'>
              ...
              <div class='tablet:grid-col-auto tablet:margin-left-2'>
                <a href='javascript:void(0);'>1-800-4-CANCER</a>
              </div>
              <div class='tablet:grid-col-auto tablet:margin-left-2'>
                <a href='javascript:void(0);'>NCIinfo@nih.gov</a>
              </div>
            </div>
          </div>
        </div>
