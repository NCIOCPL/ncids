...
overview:
  ...
  elements:
    ...
    - description: About Links - Section is recommended. Links are customizable 
    - description: Resource Links - Section is recommended. Links are customizable 
    - description: Policies Liks - Required
    - description: Sign up for email updates - Optional
    - description: Footer Branding - Required
    - description: Follow Us Links - Optional
    - description: Contact Us - Section is required. Links are customizable  
    - description: Organization Information - Required. Links are not customizable 
    - description: Back to Top - Required
...
usage: |
  ...
  - Include standard information like contact information, disclaimers, and legal content.
    - While you'll want to limit the amount of legal content on your footer, it is standard practice to include this information in your footer— therefore, users will know to head to your footer if they are in search of this information.
