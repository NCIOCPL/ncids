...
Alternatively, each variant can be imported separately

```sass
@import "@nciocpl/ncids-css/scss/components/usa-button/button";
@import "@nciocpl/ncids-css/scss/components/usa-button/secondary";
@import "@nciocpl/ncids-css/scss/components/usa-button/base";
@import "@nciocpl/ncids-css/scss/components/usa-button/accent-cool";
@import "@nciocpl/ncids-css/scss/components/usa-button/accent-warm";
@import "@nciocpl/ncids-css/scss/components/usa-button/outline";
@import "@nciocpl/ncids-css/scss/components/usa-button/outline-inverse";
@import "@nciocpl/ncids-css/scss/components/usa-button/big";
@import "@nciocpl/ncids-css/scss/components/usa-button/nci-small";
```
