...
<div className="bg-base-lightest padding-3">
	<h3 className="margin-bottom-1">Default button</h3>
	...
	<h3 className="margin-top-2 margin-bottom-1">Buttons with External Links</h3>
	<a href="http://www.google.com" className="usa-button">
		Default
	</a>
	<a
	...
	<a href="http://www.google.com" className="usa-button usa-button--secondary">
		Focus
	</a>
</div>
...
#### NCI Buttons with External Links
...
#### NCI Buttons with External Links guidance

Clearly identify external links. Provide required notification for non-federal external links. OMB’s Policies for Federal Agency Public Websites and
Digital Services states that you **_must clearly state that the content of external links to non-federal
agency websites is not endorsed by the federal government._**

This requirement has two aspects:

- Notification: We recommend employing a clear, consistent, user-friendly approach for all external links whether government or non-government links.
...
<Code className="html">{`
<a href="http://www.google.com" class="usa-button nci-external">Link To Page</a>
<a href="http://www.google.com" class="usa-button nci-internal" disabled>SomeSite.com</a>
`}</Code>

You can also force add or remove the external link icon by adding one of these classes

- add the class **.nci-external** to add the icon to link buttons.
- add the class **.nci-internal** to remove the icon from link buttons.
...
```sass
@import "@nciocpl/ncids-css/scss/components/usa-button/all";
```
