...
variations:
  intro: |
    Choose from following types of button components based on your page's content design or organizational needs.
      | Variant         |                                                                          |
      | --------------- | ------------------------------------------------------------------------ |
      | Default Guide Card  | <ul><li>Use the default guide card to thematically group two to six CTAs under a title.</li></ul>|
      | Guide Card with Image and Description  | <ul><li>Use the guide card with image and description to thematically group two to six CTAs with an image and description to provide further context for the grouping of CTAs. </li></ul>|

usage: |
  - Use heading to introduce the two to six CTAs featured on your guide card.
  ...
  - Use CTA buttons to provide users with links to two to six related CTAs. CTAs can lead to internal or external pages.
...
code_snippets:
  elements:
    ...
    - title: Guide Card without Image and Description with External Links
      preview: true
      twig_template_path: components/nci-guide-card/nci-guide-card.twig
      code: >
        {
    ...
    - title: Guide Card with Image and Description and External Links
      preview: true
      twig_template_path: components/nci-guide-card/nci-guide-card.twig
      code: >
        {
