...
usage: |
  ...
  ### When to consider something else
    ...
    - Showcasing one primary CTA or four CTAs that should be more prominently displayed than all other information on the page.
      - Alternative: [Hero with CTA Button](./hero)
      - Alternative: [Hero with CTA button + CTA strip or a Hero with tagline only + CTA strip](./hero)
...
updates:
  - date: 2023-07-26
    version: v2.2.0
    affects: >-
      All guide card variants
    description: >-
      Adjusts spacing between guide cards; adds border radius to guide cards
  - date: 2023-03-07
    version: v1.2.0
    affects: >-
      N/A
