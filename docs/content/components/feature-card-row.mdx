			...
			<a href="https://www.cancer.gov" aria-label="Feature Card">
				<picture class="nci-card__image">
					<source
						...
						srcset="./../assets/images/news1-16x9.jpg"
					/>
					<source
						media="(max-width: 879px)"
						srcset="./../assets/images/news1-1x1.jpg"
					/>
					<source
						media="(min-width: 880px)"
						srcset="./../assets/images/news1-4x3.jpg"
					/>
		...
		<li class="nci-card">
			<a href="https://www.cancer.gov" aria-label="Feature Card">
				<picture class="nci-card__image">
					<source
						media="(max-width: 639px)"
						srcset="./../assets/images/news2-16x9.jpg"
					/>
					<source
						media="(max-width: 879px)"
						srcset="./../assets/images/news2-1x1.jpg"
					/>
					<source
						media="(min-width: 880px)"
						srcset="./../assets/images/news2-4x3.jpg"
					/>
					<img src="./../assets/images/news2-16x9.jpg" />
				</picture>
				<div class="nci-card__body">
					...
					<p class="nci-card__description>
						...
						severe COVID-19 with interferons decreased the viral load
						of SARS-CoV-2, a new study found.
					</p>
				</div>
			</a>
		</li>
		<li class="nci-card">
			<a href="https://www.cancer.gov" aria-label="Feature Card">
				<picture class="nci-card__image">
					<source
						media="(max-width: 639px)"
						srcset="./../assets/images/news3-16x9.jpg"
					/>
					<source
						media="(max-width: 879px)"
						srcset="./../assets/images/news3-1x1.jpg"
					/>
					<source
						media="(min-width: 880px)"
						srcset="./../assets/images/news3-4x3.jpg"
					/>
					<img src="./../assets/images/news3-16x9.jpg" />
				</picture>
				<div class="nci-card__body">
...
@import '@nciocpl/ncids-css/scss/components/nci-card/nci-card';
```
