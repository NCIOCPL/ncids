...
usage: |
  ...
  - Displaying large images or other media. Collection list items can feature small images to provide users with quick visual cues for specific item; however, these items are not the focal point for this component.
    - Alternative: [Card](https://designsystem-dev.cancer.gov/develop/components/card), using the [3 Card row pattern](https://designsystem-dev.cancer.gov/develop/templates/3-card-row)
    - Alternative: [Promo Block](https://designsystem-dev.cancer.gov/develop/components/promo-block)
  ...
  - Showcasing one primary CTA that should be more prominently displayed than all other information on the page.
    - Alternative: [Hero with CTA button](https://designsystem-dev.cancer.gov/develop/components/hero)
