...
usage: |
  ...
  - Leading users to promotional content
    - Alternative: Consider using components like the [promo block](./promo-block) or [card](./feature-card) to lead users to promotional content within a landing page.
