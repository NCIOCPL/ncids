...
usage: |
  ...
  - Leading users to promotional content
    - Alternative: Consider using components like the [promo block](/components/promo-block) or [card](/components/card) to lead users to promotional content within a landing page.
