...
code_snippets:
  elements:
    - title: Default site alert - emergency
      description: |
        ...
        See the [Site alert](/ncids-js/classes/usa_site_alert.USASiteAlert.html) for more information regarding the site alert's initialization.
      preview: true
      twig_template_path: components/usa-site-alert/usa-site-alert.twig
      code: >
        {
          "variant": "default",
          "modifier": "emergency",
          "ariaLabel": "Default emergency site alert example",
    ...
    - title: Default site alert - emergency with two column lists
      preview: true
      twig_template_path: components/usa-site-alert/usa-site-alert.twig
      code: >
        {
          "variant": "default",
          "modifier": "emergency",
          "ariaLabel": "Default emergency site alert example with two columns",
          "heading": "COVID-19 resources.",
          "content": {
            "modifier": "two-column",
            "links": [
              {
                "link": "#!",
                "text": "What people with cancer should know",
                "class": "text-bold text-no-underline hover:text-underline"
              },
              {
                "link": "#!",
                "text": "Get the latest public health information from CDC",
      ...
      code: >
        {
          "variant": "default",
          "modifier": "info",
          "ariaLabel": "Default info site alert example",
          "heading": "COVID-19 resources.",
          "content": {
            "modifier": "two-column",
            "links": [
      ...
      code: >
        {
          "variant": "slim",
          "modifier": "emergency",
          "ariaLabel": "Slim emergency site alert example",
      ...
      code: >
        {
          "variant": "slim",
          "modifier": "info",
          "ariaLabel": "Slim info site alert example",
          "content": "<strong>Short alert message.</strong> Additional context and followup information including <a class='usa-link' href='#!'>a link</a>."
        }
    - title: Site alert with close button
      description: |
      ...
      code: >
        {
          ...
          "modifier": "info",
          "dismissible": "true",
          "ariaLabel": "Site alert example with close",
          "content": "<strong>Short alert message.</strong> Additional context and followup information including <a class='usa-link' href='#!'>a link</a>."
        }
...
<NciDsJsInit path={props.pageContext.pagePath}>{`
	window.ncids.USASiteAlert.createAll();
`}</NciDsJsInit>
