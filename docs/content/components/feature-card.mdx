...
patterns: |
  **3-Card Row:** If used on a home page and/or landing page, consider using cards in rows of three to maintain the visual consistency of the site. Learn more about this pattern on the [3-Card Row pattern page](../../templates/feature-card-row).
...
updates:
  - date: 2023-05-18
    ...
    affects: >-
      Card
    description: >-
      Updates vertical spacing in card group
  - date: 2022-12-07
    version: v1.0.0
    affects: >-
      N/A
