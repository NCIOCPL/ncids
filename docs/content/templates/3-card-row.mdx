---
browser_title: 3-Card Row - NCI Design System
...
![3 Card Row Pattern](./images/card-row_pattern.jpg)

It is recommended that a 3-card row be composed of three ‘Cards’. Refer to [Card](/components/feature-card) for specific attributes of the card component.
...
Refer to [Card](/components/feature-card) for best practice recommendations specific to the card.
