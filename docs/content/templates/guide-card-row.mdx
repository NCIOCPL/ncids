...
![Guide card with image and description](./images/guide-card-image-description_pattern.jpg)

The 3 guide card row pattern is composed of 3 guide cards without image or description.

![Guide card without image and description](./images/guide-card-row_pattern.jpg)
