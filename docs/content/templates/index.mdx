...
A Summary Box Row is a pattern of two Summary Box component each displaying two different types of key information or next steps.

## Example NCIDS Websites

Browse through example websites that use the NCIDS and USWDS components and patterns.

- [CancerGov Home Page](/example-site/example-pages/cgov-home.html)
- [Landing Page with Title](/example-site/example-pages/landing-page-with-title.html)
- [Example Inner Page](/example-site/inner-pages/inner-page.html)
