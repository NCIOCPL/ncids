...
<a href="/get-started/designers" className="header-styled-link">Start Designing</a>

Explore our guidelines, get access to the NCIDS Figma files, and join our Figma community.

<a href="/get-started/developers" className="header-styled-link">Start Developing</a>

Set up your environment using the NCIDS components, utilities, and design tokens.

<a href="/about#contact-us" className="header-styled-link">Get Support</a>
