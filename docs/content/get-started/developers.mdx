...
Now, you can install NCIDS into your project from the command line with npm. At minimum, your project will require the `ncids-css` package. Install it via the command line:
...
## Phase 2: Compile and Import

### Step 1: Use a Sass Compiler 
...
### Step 2: Import the Compiled Package 
...
**Create a sass stylesheet in your project and import the required sass partials:**
...
**Create an index.js file. This is the entrypoint file set in the compiler of your project.**
...
**How to import and manage your Sassy Cascading Style Sheets (SCSS):** The `@use` and `@forward` directives are used to import and manage SCSS) modules and partials.
...
Reference [USWDS Settings](https://designsystem.digital.gov/documentation/settings/) documentation for information on each of the settings available in the settings files, as well as the values the settings accept. Most settings accept design tokens, eference our [Foundations](/foundations) information of our website for more information on the available tokens for color, spacing units, font size, and more.
