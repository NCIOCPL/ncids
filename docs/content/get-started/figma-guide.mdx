...
### Border, Border Radius and Outline Utilities

Not all utilities are available in the NCIDS Design Kit Library, which appears on the right-hand sidebar when you are designing a composition or prototype. Reference the [Tokens and Utilities](https://www.figma.com/design/4FeMfprVErO6esR8FLczp5/NCIDS-Design-Kit?node-id=3917-6868&t=YVntX6mh1NZavZkA-1) page in our Figma file to learn how to apply border, border radius and outline utilities to your designs.
